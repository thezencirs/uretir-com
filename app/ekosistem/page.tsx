...
const ecosystemItems = [
  ...
  { icon: Zap, title: "PuanAI", description: "Alışverişini yaz; doğrulanmış kampanyaları kartlarına ve harcama koşullarına göre karşılaştır.", href: "/puan-ai", color: "#78a5b6" },
  { icon: Sparkles, title: "Yapay zekâ araçları", description: "ÜretirAI, TeşvikAI, FiyatAI, MimarAI, İndirimAI ve MagazinAI ortak kaynak, rehber ve keşif sistemiyle birbirine bağlı.", href: "/araclar", color: "#8b80c2" },
