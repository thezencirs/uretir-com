...
const ecosystemItems = [
  ...
  { icon: Zap, title: "PuanAI", description: "Alışverişini yaz, kartlarını karşılaştır ve harcamalarını planla. Örnek kampanya verileriyle çalışan PuanAI uygulaması.", href: "/puan-ai#danisman", color: "#78a5b6" },
