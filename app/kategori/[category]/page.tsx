...
export function generateStaticParams() {
  return categories
    .filter((category) => getPostsByCategory(category.slug).some((post) => isVisibleReference(createArticleDocument(post))))
