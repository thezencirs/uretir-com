...
const ecosystemCards = [
  ...
  { number: "02", icon: Zap, title: "PuanAI", description: "Örnek verilerle alışveriş kararını açıkla", color: "#78a5b6", href: "/puan-ai" },
    ...
    <section className="section-wrap grid gap-12 py-14 md:min-h-[calc(100vh-78px)] md:grid-cols-[.9fr_1.1fr] md:items-center md:gap-20 md:py-20">
      <div className="max-w-xl">
        <div className="flex items-center gap-4">
          <p className="rule-label">Merak edenler için yaşayan bir evren</p>
        ...
        <p className="mt-8 max-w-md text-base leading-7 text-muted md:text-lg">Üretim, teknoloji ve yapay zekânın birbirine bağlandığı yaşayan bir ekosistem. Merak ettiğin gezegene yaklaş.</p>
      ...
      <div className="relative"><HeroArt /><span className="absolute -bottom-3 -left-3 border hairline bg-[color:var(--background)] px-4 py-2 text-[10px] font-bold uppercase tracking-[.14em] text-muted md:left-[-18px]">01 — 06 / Modüller</span></div>
    </section>
