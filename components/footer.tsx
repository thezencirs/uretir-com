...
export function Footer() {
  return <footer className="mt-28 bg-[#171916] text-[#f1f2eb]">
    ...
    <div className="section-wrap grid gap-14 py-14 md:grid-cols-[1.5fr_1fr_1fr] md:py-20">
      ...
      <div><p className="eyebrow text-[#848b80]">Keşfet</p><div className="mt-5 grid gap-3 text-sm text-[#c4c8bd]"><Link href="/blog">Tüm yazılar</Link><Link href="/uretir-ai">UretirAI</Link><Link href="/puan-ai">PuanAI</Link><Link href="/tesvik-ai">TesvikAI</Link><Link href="/fiyat-ai">FiyatAI</Link><Link href="/ihracat-ai">IhracatAI</Link><Link href="/insan-ai">InsanAI</Link><Link href="/trendler">Trend Merkezi</Link></div></div>
