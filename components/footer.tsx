...
export function Footer() {
  return <footer className="mt-28 bg-[#171916] text-[#f1f2eb]">
    ...
    <div className="section-wrap grid gap-14 py-14 md:grid-cols-[1.5fr_1fr_1fr] md:py-20">
      <div><Link href="/" className="font-display text-4xl font-bold tracking-[-.1em]">üretir<span className="text-[#c8f560]">.</span></Link><p className="mt-5 max-w-xs text-sm leading-6 text-[#a9ada2]">Fikri gerçeğe dönüştürenler için üretim, teknoloji ve ilham.</p><div className="mt-8 flex gap-3"><a className="rounded-full border border-white/15 p-2.5 text-[#a9ada2] transition hover:border-white/40 hover:text-white" href="#" aria-label="Instagram"><Instagram size={16} /></a><a className="rounded-full border border-white/15 p-2.5 text-[#a9ada2] transition hover:border-white/40 hover:text-white" href="#" aria-label="LinkedIn"><Linkedin size={16} /></a><a className="rounded-full border border-white/15 p-2.5 text-[#a9ada2] transition hover:border-white/40 hover:text-white" href="#" aria-label="Twitter"><Twitter size={16} /></a></div></div>
