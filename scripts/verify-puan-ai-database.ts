...
async function main() {
  ...
  try {
    ...
    process.stdout.write(`PuanAI database verified: ${counts.join("/")} records across required tables; ${results.length} grounded Migros result(s); chat and admin CRUD passed.\n`);
  } finally {
